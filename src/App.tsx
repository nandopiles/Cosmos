 ...
 * HUD y modal).
 *
 * Extra técnico: deep-linking por hash (#p2 abre el proyecto y teletransporta).
 */
export default function App() {
  const reducedMotion = useReducedMotion();
  const canvas = useLivingCanvas(reducedMotion);
  const { worldElRef, viewportElRef, trailCanvasRef, worldSize, teleport } = canvas;
  ...
  // Deep-linking: al cargar, si el hash apunta a un proyecto, ábrelo y viaja.
  useEffect(() => {
