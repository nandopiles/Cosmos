    ...
    <PhysicsNode id="node-toy-zone" category="interactive" top={2500} left={1900} width={480} index={index} withAura>
      <div className="glass-panel rounded-[40px] border border-lime-400/20 p-8">
        <div className="mb-4 flex items-center justify-between">
          <span className="font-mono text-xs text-lime-300">LABORATORIO DE GRAVEDAD</span>
        ...
        <p className="mb-6 text-xs leading-relaxed text-slate-300">
          Lanza este pequeño planeta y observa cómo la gravedad lo hace caer y rebotar. Es la misma fuerza que curva las
          órbitas de los mundos alrededor del Sol:
        </p>
        ...
        >
          ...
          <div
            ref={orbRef}
            className="absolute left-0 top-0 flex h-16 w-16 cursor-grab items-center justify-center rounded-full bg-gradient-to-tr from-sky-500 to-emerald-300 font-mono text-[10px] font-bold text-slate-950 shadow-[0_0_30px_rgba(56,189,248,0.6)] active:cursor-grabbing"
          >
            Lánzame
          </div>
          <span className="absolute bottom-2 left-3 font-mono text-[10px] text-slate-500">Gravedad: 9,8 m/s²</span>
        </div>
      </div>
    </PhysicsNode>
  );
